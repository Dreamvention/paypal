...
class ControllerPaymentPayPal extends Controller {
	...
	public function auth() {
		...
		$data['partner_url'] = str_replace(array('&amp;', '?'), array('%26', '%3F'), $this->url->link('payment/paypal', 'token=' . $this->session->data['token'], true));
		$data['callback_url'] = str_replace('&amp;', '&', $this->url->link('payment/paypal/callback', 'token=' . $this->session->data['token'], true));
		$data['connect_url'] = str_replace('&amp;', '&', $this->url->link('payment/paypal/connect', 'token=' . $this->session->data['token'], true));
		...
		$this->response->setOutput($this->load->view('payment/paypal/auth', $data));
	}
	...
	public function dashboard() {
		...
		$data['href_fastlane'] = $this->url->link('payment/paypal/fastlane', 'token=' . $this->session->data['token'], true);
		$data['href_message_configurator'] = $this->url->link('payment/paypal/message_configurator', 'token=' . $this->session->data['token'], true);
		$data['href_message_setting'] = $this->url->link('payment/paypal/message_setting', 'token=' . $this->session->data['token'], true);
		...
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], true);
		$data['sale_analytics_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/getSaleAnalytics', 'token=' . $this->session->data['token'], true));
		$data['agree_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/agree', 'token=' . $this->session->data['token'], true));
		...
		$paypal_sale_total = $this->model_payment_paypal->getTotalSales();
		...
		$this->response->setOutput($this->load->view('payment/paypal/dashboard', $data));
	}
	...
	public function general() {
		...
		$data['action'] = $this->url->link('payment/paypal/save', 'token=' . $this->session->data['token'], true);
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], true);
		$data['disconnect_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/disconnect', 'token=' . $this->session->data['token'], true));
		$data['agree_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/agree', 'token=' . $this->session->data['token'], true));
		...
		$this->response->setOutput($this->load->view('payment/paypal/general', $data));
	}
	...
	public function applepay_button() {
		...
		$data['action'] = $this->url->link('payment/paypal/save', 'token=' . $this->session->data['token'], true);
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], true);
		$data['applepay_download_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/downloadAssociationFile', 'token=' . $this->session->data['token'], true));
		$data['applepay_download_host_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/downloadHostAssociationFile', 'token=' . $this->session->data['token'], true));	
		$data['agree_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/agree', 'token=' . $this->session->data['token'], true));
		...
		$this->response->setOutput($this->load->view('payment/paypal/applepay_button', $data));
	}
	...
	public function card() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/card', $data));
	}
	...
	public function fastlane() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/fastlane', $data));
	}
	...
	public function message_configurator() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/message_configurator', $data));
	}
	...
	public function message_setting() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/message_setting', $data));
	}
	...
	public function order_status() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/order_status', $data));
	}
	...
	public function contact() {
		...
		$data['action'] = $this->url->link('payment/paypal/save', 'token=' . $this->session->data['token'], true);
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], true);
		$data['contact_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/sendContact', 'token=' . $this->session->data['token'], true));
		$data['agree_url'] =  str_replace('&amp;', '&', $this->url->link('payment/paypal/agree', 'token=' . $this->session->data['token'], true));
		...
		$this->response->setOutput($this->load->view('payment/paypal/contact', $data));
	}
	...
	public function getSaleAnalytics() {
		...
		switch ($range) {
			default:
			case 'day':
				$results = $this->model_payment_paypal->getTotalSalesByDay();
				...
				break;
			case 'week':
				$results = $this->model_payment_paypal->getTotalSalesByWeek();
				...
				break;
			case 'month':
				$results = $this->model_payment_paypal->getTotalSalesByMonth();
				...
				break;
			case 'year':
				$results = $this->model_payment_paypal->getTotalSalesByYear();
	...
	public function sendContact() {
		...
		if (isset($this->request->post['paypal_setting']['contact'])) {
			$this->model_payment_paypal->sendContact($this->request->post['paypal_setting']['contact']);
	...
	public function agree() {		
		...
		$this->model_payment_paypal->setAgreeStatus();
	...
	public function install() {		
		...
		$this->model_extension_event->addEvent('paypal_content_top', 'catalog/controller/common/content_top/before', 'payment/paypal/content_top_before');
	...
	public function update() {
		...
		if (version_compare((string)$this->config->get('paypal_version'), '3.1.0', '<')) {			
			$this->load->model('setting/setting');
	...
	public function customer_delete_customer_before($route, &$data) {
		...
		$this->model_payment_paypal->deletePayPalCustomerTokens($customer_id);
	}
