...
class ModelPaymentPayPal extends Model {
	...
	public function configureSmartButton() {
        ...
        if (empty($query->row)) {
			...
			$this->model_user_user_group->addPermission($user_group_id, 'access', 'module/paypal_smart_button');
			$this->model_user_user_group->addPermission($user_group_id, 'modify', 'module/paypal_smart_button');
			
			$this->load->controller('module/paypal_smart_button/install');
        }
	}
