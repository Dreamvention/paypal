...
$(document).on('click', '.button-payment-address', function(event) {
	...
	$('#payment_address').load('index.php?route=module/paypal_smart_button/paymentAddress #payment_address >', onLoadPaymentAddress);
...
$(document).on('click', '.button-shipping-address', function(event) {
	...
	$('#shipping_address').load('index.php?route=module/paypal_smart_button/shippingAddress #shipping_address >', onLoadShippingAddress);
...
function onLoadPaymentAddress() {
	...
	$('#payment_address .button-confirm').on('click', function(event) {
		$.ajax({
			type: 'post',
			url: 'index.php?route=module/paypal_smart_button/confirmPaymentAddress',
...
function onLoadShippingAddress() {
	...
	$('#shipping_address .button-confirm').on('click', function(event) {
		$.ajax({
			type: 'post',
			url: 'index.php?route=module/paypal_smart_button/confirmShippingAddress',
