...
$(document).on('click', '.button-payment-address', function(event) {
	...
	$('#payment_address').load('index.php?route=payment/paypal/paymentAddress #payment_address >', onLoadPaymentAddress);
...
$(document).on('click', '.button-shipping-address', function(event) {
	...
	$('#shipping_address').load('index.php?route=payment/paypal/shippingAddress #shipping_address >', onLoadShippingAddress);
...
function onLoadPaymentAddress() {
	...
	$('#payment_address .button-confirm').on('click', function(event) {
		$.ajax({
			type: 'post',
			url: 'index.php?route=payment/paypal/confirmPaymentAddress',
...
function onLoadShippingAddress() {
	...
	$('#shipping_address .button-confirm').on('click', function(event) {
		$.ajax({
			type: 'post',
			url: 'index.php?route=payment/paypal/confirmShippingAddress',
