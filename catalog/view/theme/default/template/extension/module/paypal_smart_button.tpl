...
window.addEventListener('load', function () {
	if ($('<?php echo $insert_tag; ?>').length) {
		...
		if (typeof paypal_sdk === 'undefined') {
			...
			script.type = 'text/javascript';
			script.src = 'https://www.paypal.com/sdk/js?components=buttons,messages&client-id=<?php echo $client_id; ?>&merchant-id=<?php echo $merchant_id; ?>&currency=<?php echo $currency_code; ?>&intent=<?php echo $transaction_method; ?>&commit=false<?php if ($environment == 'sandbox') { ?>&buyer-country=NL<?php } ?>';
			script.setAttribute('data-partner-attribution-id', '<?php echo $artner_id; ?>');
