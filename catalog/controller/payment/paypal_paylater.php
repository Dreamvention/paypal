<?php
class ControllerPaymentPayPalPayLater extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($this->config->get('paypal_status') && $this->config->get('paypal_client_id') && $this->config->get('paypal_secret') && $agree_status) {
			...
			return $this->load->view('payment/paypal/paypal_paylater', $data);
		}
	}
	...
	public function modal() {
		...
		$this->response->setOutput($this->load->view('payment/paypal/paypal_paylater_modal', $data));
	}
}