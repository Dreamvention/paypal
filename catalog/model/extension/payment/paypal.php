...
class ModelExtensionPaymentPayPal extends Model {
	...
	public function update() {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "event` SET `code` = 'paypal_content_top', `trigger` = 'catalog/controller/common/content_top/before', `action` = 'extension/payment/paypal/content_top_before', `status` = '1'");
